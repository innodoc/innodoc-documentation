# TODO
# - MInfo, MExample, MExperiment
# - handle ifttm??

################################################################################
# these filters should probably happen
# - preferably in tree_pandoc.tex
# - or if this is not feasible in mintmod_filter.py
...
# TODO Where to find \begin and \end commands I pandoc AST??
