...
\texttt{$\backslash$MAutoRouletteExercises\{parabelaufgabe.py\}\{5\}\{PREFIX1\}\{0\}}
...
\MAutoRouletteExercises{parabelaufgabe.py}{5}{PREFIX1}{0}
%\end{MExercise}
Roulette Typ 1:
\MAutoRouletteExercises{parabelaufgabe.py}{5}{PREFIX2}{1}
Roulette Typ 2:
\MAutoRouletteExercises{parabelaufgabe.py}{5}{PREFIX3}{2}
