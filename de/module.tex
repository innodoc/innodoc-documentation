...
%\end{MExercise}
\MTitle{Roulett typ 1:}
\MAutoRouletteExercises{parabelaufgabe.py}{5}{PREFIX1}{1}
\MTitlle{Roulett typ 2:}
\MAutoRouletteExercises{parabelaufgabe.py}{5}{PREFIX1}{2}
